...
func AddKeys(kv models.KV, isFlatten bool, dic *di.Container) (keys []models.KeyOnly, err errors.EdgeX) {
...
func PublishKeyChange(data []byte, key string, ctx context.Context, dic *di.Container) {
	...
	publishTopic := configuration.MessageQueue.PublishTopicPrefix + "/" + key
