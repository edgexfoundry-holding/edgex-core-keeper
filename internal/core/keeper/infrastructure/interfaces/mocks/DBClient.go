...
func (_m *DBClient) AddKeeperKeys(kv models.KV, isFlatten bool) ([]models.KeyOnly, errors.EdgeX) {
	ret := _m.Called(kv, isFlatten)

	var r0 []models.KeyOnly
	if rf, ok := ret.Get(0).(func(models.KV, bool) []models.KeyOnly); ok {
		r0 = rf(kv, isFlatten)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 errors.EdgeX
	if rf, ok := ret.Get(1).(func(models.KV, bool) errors.EdgeX); ok {
		r1 = rf(kv, isFlatten)
	} else {
		if ret.Get(1) != nil {
